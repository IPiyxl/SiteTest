...
function fetchData() {
    fetch('./posts.json')
        ...
        .then(data => {
            ...
            data.forEach(item => {
                const listItem = $(
                    `<div class="anuntSpital flex flex-col w-full sm:w-[48%] lg:w-[32%] bg-zinc-600 rounded-xl shadow-md overflow-hidden border border-zinc-600 dark:border-zinc-700">
